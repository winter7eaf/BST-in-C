...
//     printf("leaf count of a : %d\n", numberLeaves(a));
//     printf("leaf count of b : %d\n", numberLeaves(b));
    


//     int c = numberLeaves(a);
//     assert(c == 1);
//     printf("confirmed c, number leaves\n");

//     c = nodeDepth(a,b);
//     printf("after node depth : %d\n", c);
//     assert(c == 1);
//     printf("confirmed c, node depth\n");

//     a = removeSubtree(a, 2);

//     displaySubtree(a);

//     testRoot = addNode(NULL, 10);
//     test = addNode(test, 100);
//     test = addNode(test, 7);
//     test = addNode(test, 9);
//     test = addNode(test, 8);
//     test = addNode(test, 5);
//     test = addNode(test, 150);

//     printf("test tree: ");
//     displaySubtree(testRoot);
//     printf("test: \n");
//     displaySubtree(test);

//     printf("leaf count of test : %d\n", numberLeaves(test));

//     test = removeNode(test,7);
//     displaySubtree(test); 

// printf("try remove?");
//     test = removeSubtree(test, 9); 
